<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="WebApplication1.Payment1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="padding-top: 150px;">
        <a href="AddToCart1.aspx" id="goToAddToCart1Link1">Back to Your Cart</a>
    ...
    <div class="container">
        ...
        <asp:TextBox ID="name" runat="server" TextMode="SingleLine" Width="90%"></asp:TextBox>
        <br />
        ...
        <div class="exp-cvc">
            <div class="expiration">
                ...
                <asp:TextBox ID="expiry" runat="server" MaxLength="7" required pattern="^(0[1-9]|1[0-2])/\d{4}$" Width="100%" Placeholder="MM/YYYY"></asp:TextBox>
            </div>
            <div class="security">
        ...
        <div class="btn">
           ...
           <asp:Button ID="submit" runat="server" Text="Submit" onclientclick='redirect()' Style="background-color: #F9E450; border: none; padding: 0px; padding-bottom: 15px;" />
        </div>

         <a href="PaymentSuccessful.aspx" id="goToPaymentSuc">Proceed to Payment</a>

    </div>

    <script>
        function redirect() {
            location.href = 'PaymentSuccessful.aspx';
        }
    </script>
